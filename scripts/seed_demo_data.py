...
# Minimal valid JPEG payload, verified to decode in Pillow and browsers.
DEMO_IMAGE_BYTES = base64.b64decode(
    ...
    b"MjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjL/wAARCAACAAIDASIA"
    ...
    b"uLm6wsPExcbHyMnK0tPU1dbX2Nna4uPk5ebn6Onq8vP09fb3+Pn6/9oADAMBAAIRAxEAPwD3aiii"
    b"tDM//9k="
)
